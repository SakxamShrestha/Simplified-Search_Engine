...
def get_print(input_mock, answers):
    ...
    input_mock.side_effect = \
        lambda question: _print_value(question, str(answers.pop())) # prints input question along with given answer

    # Saves printed output into variable so can return it to compare in test
